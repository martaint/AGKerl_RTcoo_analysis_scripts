...
# Trying markers for perinueral invasion by PNS cells
...
FeaturePlot(atrt.integrated, features = c("Notch1", "Jag1"), pt.size = 1, cols = c("gray", "blue"), order = T)
...
write.table(tum_mat, file = "/marta_home/scRNAseq_Ranalysis/Seurat_v3/COO-cibersort/MYC_EC_bulk.txt",
...
write.table(tum_mat, file = "/marta_home/scRNAseq_Ranalysis/Seurat_v3/COO-cibersort/MYC_EC_bulk_clust.txt",
            quote = FALSE, sep = "\t", row.names = F, col.names = T)
...
```{r}
saveRDS(atrt.integrated, file = "/marta_home/GEO_COO/single_cell/MYC_eRT_integrated_seurat_obj.rds")
```