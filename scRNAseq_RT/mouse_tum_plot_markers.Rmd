...
urgent.markers <- read_excel("/marta_home/scRNAseq_Ranalysis/markers/urgent_markers.xlsx")

genes <- as.character(unlist(urgent.markers$RT))
...
for (g in genes){
  ...
  tiff(paste0("./urgent_markers/RT_mou_",g, ".tiff"), width = 1200, height = 800)
  print(CombinePlots(list(p1,p2,p3,p4), ncol = 2, legend = "right"))
  dev.off()
}
